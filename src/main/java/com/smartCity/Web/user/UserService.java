...
public class UserService {
  ...
  public void sendPasswordResetOtp(String email) {
    ...
    passwordResetOtps.put(
        normalizeEmail(email),
        new PasswordResetOtp(
            passwordEncoder.encode(otp), System.currentTimeMillis() + RESET_OTP_TTL_MILLIS));
  ...
  public void resetPasswordWithOtp(String email, String otp, String newPassword) {
    ...
    User user =
        repo.findByEmail(normalizedEmail).orElseThrow(() -> new RuntimeException("User not found"));
  ...
  public User loginWithGoogle(String credential, Role requestedRole) {
    ...
    User user =
        repo.findByEmail(googleUser.email())
