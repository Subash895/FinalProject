...
public class DataSeeder implements CommandLineRunner {
	...
	private User updateUser(User existing, String name, Role role) {
		...
		if (existing.getPassword() == null || !passwordEncoder.matches(DEFAULT_PASSWORD, existing.getPassword())) {
	...
	private Business ensureBusiness(User owner) {
		...
		Business business = new Business(owner, "Subbu Smart Services",
	...
	private void ensureAdvertisement(Business business) {
		...
		Advertisement advertisement = new Advertisement(business, "Welcome Offer",
				"Seed advertisement for the Smart City platform.", 499.0);
	...
	private void ensureCityHistory(City city) {
		...
		cityHistoryRepository.save(new CityHistory(city, "City Snapshot",
				"Mysuru is seeded as the default city for demo and testing."));
	}
	...
	private void ensureEvent(City city) {
		...
		eventRepository.save(new Event(city, "Smart City Expo",
	...
	private void ensureNews(City city) {
		...
		newsRepository.save(new News(city, "Platform Seeded",
	...
	private void ensurePlace(City city) {
		...
		placeRepository.save(new Place(city, "City Center",
				"Sample destination created automatically.",
				"Landmark", "Mysuru Central", 12.2958, 76.6394));
	}
