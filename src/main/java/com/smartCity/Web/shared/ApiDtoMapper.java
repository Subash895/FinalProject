...
public class ApiDtoMapper {
  ...
  public Business toBusiness(BusinessDtos.BusinessRequest request) {
    ...
    business.setOwner(
        resolveUser(request.ownerId(), request.owner() == null ? null : request.owner().id()));
  ...
  public Advertisement toAdvertisement(AdvertisementDtos.AdvertisementRequest request) {
    ...
    advertisement.setBusiness(
        resolveBusiness(
            request.businessId(), request.business() == null ? null : request.business().id()));
  ...
  public CityHistory toCityHistory(CityHistoryDtos.CityHistoryRequest request) {
    ...
    history.setCity(
        resolveCity(request.cityId(), request.city() == null ? null : request.city().id()));
  ...
  public Comment toComment(CommentDtos.CommentRequest request) {
    ...
    comment.setPost(
        resolveForumPost(request.postId(), request.post() == null ? null : request.post().id()));
    comment.setUser(
        resolveUser(request.userId(), request.user() == null ? null : request.user().id()));
  ...
  public MarketRateDtos.MarketRateResponse toMarketRateResponse(MarketRate rate) {
    return new MarketRateDtos.MarketRateResponse(
        rate.getId(), rate.getProductName(), rate.getPrice(), rate.getUnit(), rate.getPriceDate());
  }
  ...
  public SubscriptionDtos.SubscriptionResponse toSubscriptionResponse(Subscription subscription) {
    return new SubscriptionDtos.SubscriptionResponse(
        ...
        subscription.getProviderOrderId(),
        subscription.getProviderSubscriptionId(),
        subscription.getProviderPaymentId(),
