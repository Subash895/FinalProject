    ...
    try {
      ...
      <div class="business-card glass-card" style="animation-delay:${i * 0.05}s">
        ...
        <div class="card-actions">
          <button class="btn btn-edit btn-sm" onclick='editBusiness(${b.id}, ${JSON.stringify(b)})'>✏️ Edit</button>
          <button class="btn btn-delete btn-sm" onclick="deleteBusiness(${b.id}, '${esc(b.name)}')">🗑️ Delete</button>
        </div>
      </div>`).join("");
    } catch {
